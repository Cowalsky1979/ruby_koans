...
class AboutJavaInterop < Neo::Koan
  ...
  def test_some_ruby_objects_can_be_coerced_to_java
    ...
    assert_equal Java::JavaLang::Integer, 1.to_java.class
  ...
  def test_some_ruby_objects_are_not_coerced_to_what_you_might_expect
    assert_equal true, [].to_java.class == Java::JavaUtil::ArrayList
    assert_equal true, {}.to_java.class == Java::JavaUtil::HashMap
    assert_equal true, Object.new.to_java.class == Java::JavaLang::Object
  end
