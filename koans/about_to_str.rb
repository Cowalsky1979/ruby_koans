...
class AboutToStr < Neo::Koan
  ...
  def test_to_str_allows_objects_to_be_treated_as_strings
    # Since File.exist? expects a string and CanBeTreatedAsString responds to to_str,
    # it allows the object to be treated like a string. In this case, there is unlikely
    # a file called "string-like", so File.exist? will return false.
